...
namespace Day13_Ado.Net.SqlSevices
{
    ...
    {
        public SortedList<string, CommandType> dbObjects;
        public static Dictionary<string, SortedList<string, CommandType>> cacheData;
        ...
        private void RetrieveStoredProcedures(string connectionString, NpgsqlConnection connection)
        {
            ExtractSchemaDetail(connectionString, connection, "Procedures", "specific_name", CommandType.StoredProcedure);
        }

        private void ExtractSchemaDetail(string connectionString, NpgsqlConnection connection, string collectionName, string columnName, CommandType type)
        {
